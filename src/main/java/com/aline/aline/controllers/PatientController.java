...
public class PatientController {
    ...
    public ResponseEntity<Page<PatientListDto>> getAllPatients(
        ...
        Page<PatientListDto> getPatientDtoList = this.patientService.getAllPatients(pageDto, filterPatientDto);
